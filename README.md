...
Soy estadística con más de 12 años transformando datos en decisiones reales en sectores como energía, educación y finanzas. Hoy estoy en una transición apasionante: combinando mi base analítica sólida con **Inteligencia Artificial** y **desarrollo web** para construir soluciones con impacto.

- 🎓 Estadística de formación, líder en transformación digital por convicción
- 🤖 Aprendiendo **Antigravity** y **Stitch** para llevar mis proyectos al siguiente nivel
- 🇨🇱 Basada en Chile, con proyectos que ya cruzan fronteras
- 🌀 Los fractales no son solo matemática — son una filosofía de vida
...
![Hostinger](https://img.shields.io/badge/Hostinger_VPS-673DE6?style=for-the-badge&logo=hostinger&logoColor=white)
...
Siempre abierta a colaborar en datos, IA o educación. Si tienes una idea interesante, escríbeme.
...
![footer](https://capsule-render.vercel.app/api?type=waving&color=0:00C9FF,100:6A0DAD&height=100&section=footer)
